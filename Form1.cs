...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        public void BLISCH2(int[] record, int[] link, int num, int mod, int[] probes, int prbNum, int flag)//BLISCH de recursive olarak çağrılıyor
        {
            prbNum++;
            if (flag == 0)
            {
        ...
        public void LICH2(int[] record, int[] link, int num, int linkNum, int[] probes, int prbNum)//LICH de recursive olarak çağrılıyor
        {
            prbNum++;
            for (int i = (record.Length - 1); i >= 0; i--)
            {
